...
public class QuizDtoMapper {
    ...
    public QuizDTO toQuizDTO(Quiz quiz) {
        return new QuizDTO(
                ...
                quiz.getTitle(),
                quiz.getDescription(),
                quiz.getAvailableFrom()  != null ? quiz.getAvailableFrom().format(ISO_WITH_SECONDS)  : null,
                quiz.getAvailableUntil() != null ? quiz.getAvailableUntil().format(ISO_WITH_SECONDS) : null,
