...
import { Clock, Users, BookOpen, Loader2, AlertTriangle, Plus, MoreVertical, Edit, Trash2 } from "lucide-react"
        ...
        <div className="p-3 sm:p-4 md:p-6 lg:p-8 space-y-6 sm:space-y-8">
            ...
            <Card className="p-6 sm:p-8 lg:p-10">
                <div className="flex justify-between items-center mb-6">
                    <ComponentTitle className="text-2xl font-bold">Course Units</ComponentTitle>
                    <Button 
                ...
                {units.length === 0 && (
                    <div className="text-center py-12 border-2 border-dashed border-border rounded-lg">
                        ...
                        <h3 className="text-lg font-semibold text-muted-foreground mb-2">No units yet</h3>
                        <p className="text-muted-foreground mb-4">Start by creating your first unit</p>
...
// Individual Unit Card Component (keep the same as before)
