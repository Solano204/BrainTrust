...
export const quizKeys = {
  ...
  listUnit: (courseId: string, unitId: string) =>
    [...quizKeys.lists(), courseId, unitId] as const,
  details: () => [...quizKeys.all, "detail"] as const,
  detail: (id: string) => [...quizKeys.details(), id] as const,
submissionDetail: (submissionId: string) =>
    [... quizKeys.submissions(), "detail", submissionId] as const,
  ...
  submissionQuizDetail: (submissionId: string) =>
    [...quizKeys.all, "submission-quiz", submissionId] as const,
